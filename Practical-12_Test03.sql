...
EXEC InsertIntoEmployee @FirstName='akash',@MiddleName=NUll,@LastName='Rana',@DOB='1999-02-02' ,@MobileNumber='156462656',@Address='akjsadnidw',@Salary=500,@DesignationId='1';
